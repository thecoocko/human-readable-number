module.exports = function toReadable(number) {
 ...
 /*  if(y<2) return dg[number];
  ...
  if (number.toString().length===2) return `${tw[number.toString()[0]]} ${dg[number.toString()[1]]}`;
  ...
  if(number.toString().length === 3){
    ...
    if(number.toString()[1]!=='0' && number.toString()[2]==='0') {
      return `${dg[number.toString()[0]]} hundred ${tw[number.toString()[1]]}`
    }
    if(number.toString()[1]!=='0' && number.toString()[2]!=='0'){
      return `${dg[number.toString()[0]]} hundred ${tw[number.toString()[1]]} ${dg[number.toString()[2]]}`
    }
